...
public:
    ...
    static vector<size_t> GetFeaturesInArea(const ORBextractor::Ptr ORBextractorLeft, const vector<cv::KeyPoint> &keypoints_l, const float &x, const float &y, const float &r, const int minLevel = -1, const int maxLevel = -1);
    ...
    static int nlevels;
    static int iniThFAST;
    static int minThFAST;
